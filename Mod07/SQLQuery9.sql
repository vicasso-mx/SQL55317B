...
SELECT @ClientesXML.value('(/Clientes/Cliente/IdCliente)[1]', 'INT') AS IdCliente
, @ClientesXML.value('(/Clientes/Cliente/Cliente.Nombre)[1]', 'NVARCHAR(50)') AS Nombre
, @ClientesXML.value('(/Clientes/Cliente/Cliente.Apellido)[1]', 'NVARCHAR(50)') AS Apellido
, @ClientesXML.value('(/Clientes/Cliente/Empresa)[1]', 'NVARCHAR(100)') AS Empresa
, @ClientesXML.value('(/Clientes/Cliente/Correo)[1]', 'NVARCHAR(100)') AS Correo
